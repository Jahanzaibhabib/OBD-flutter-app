            ...
            Expanded(child: Column(
              ...
              children: [
                ...
                FittedBox( fit : BoxFit.scaleDown , child: Padding(
                  ...
                  child: Text("GET AN ODB "
                    "ADAPTER" ,
                    style:
                  Montserrat
                    (25, Colors.white, FontWeight.w800),),
                )),
              ],
            )),
                ...
                children: [
                  CustomButtonForStep2((){
                    navigateToScreen4(context);
                      ...
                      Colors.white, Colors.cyan, 1, FontWeight.w600 , context),

            SizedBox(height: height(context)*.02 ,),
            CustomButtonForStep2((){
              navigateToScreen4(context);}   , "I'll do this later", 15,
                Colors.white, Colors.cyan, 0, FontWeight.w600 , context),
                ],
              ),
            ),
